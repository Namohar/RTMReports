<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="RecordsWeeklyView, App_Web_ecwshzyq" %>
  ...
  <script language="javascript" type="text/javascript">
   ...
   <script type="text/javascript">
       $(document).ready(function () {
           ...
           var tabId = selectedTab.val() != "" ? selectedTab.val() : "sunday";
                                    ...
                                    <asp:UpdatePanel ID="upnlSun" runat="server" UpdateMode="Conditional">
                                       <ContentTemplate>
                                          <asp:Panel ID="pnlSunday" runat="server" ScrollBars="Horizontal">
                                           ...
                                           <asp:GridView ID="gvRecordsSunday" runat="server" AutoGenerateColumns="False" AllowSorting="True" onsorting="gvRecordsSunday_Sorting" HeaderStyle-ForeColor="#428bca"
                                                Width="100%" 
                                                DataKeyNames="R_ID" 
                                               ...
                                               ondatabound="gvRecordsSunday_DataBound" >
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Task" SortExpression="TL_Task">
                                                        <FooterTemplate>
                                                            <asp:DropDownList ID="ddlSAddTask" runat="server" onselectedindexchanged="ddlSAddTask_SelectedIndexChanged" AutoPostBack="True">
                                                            </asp:DropDownList>
                                                        </FooterTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Comments">
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtSGVAddComments" runat="server"></asp:TextBox>                                                            
                                                        </FooterTemplate>
                                                        <ItemTemplate>
                                    ...
                                    <asp:UpdatePanel ID="upnlMon" runat="server" UpdateMode="Conditional">
                                     <ContentTemplate>
                                        <asp:Panel ID="pnlMonday" runat="server" ScrollBars="Horizontal" >
                                         ...
                                         <asp:GridView ID="gvRecordsMonday" runat="server" AutoGenerateColumns="False" AllowSorting="True" onsorting="gvRecordsMonday_Sorting"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Task" SortExpression="TL_Task">
                                                    <FooterTemplate>
                                                            <asp:DropDownList ID="ddlMAddTask" runat="server" onselectedindexchanged="ddlMAddTask_SelectedIndexChanged" AutoPostBack="True">
                                                            </asp:DropDownList>
                                                        </FooterTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Comments">
                                                    <FooterTemplate>
                                                            <asp:TextBox ID="txtMGVAddComments" runat="server"></asp:TextBox>                                                            
                                                        </FooterTemplate>
                                                    <ItemTemplate>
                                      ...
                                      <ContentTemplate>
                                         <asp:Panel ID="pnlTuesday" runat="server" ScrollBars="Horizontal">
                                          <h4><asp:Label ID="lblTuesday" runat="server" Text=""></asp:Label></h4>
                                           ...
                                           <br />
                                           <br />
                                          <asp:GridView ID="gvRecordsTue" runat="server" AutoGenerateColumns="False" AllowSorting="True" onsorting="gvRecordsTue_Sorting" HeaderStyle-ForeColor="#428bca"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Task" SortExpression="TL_Task">
                                                    <FooterTemplate>
                                                            <asp:DropDownList ID="ddlTAddTask" runat="server" onselectedindexchanged="ddlTAddTask_SelectedIndexChanged" AutoPostBack="True">
                                                            </asp:DropDownList>
                                                        </FooterTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Comments">
                                                    <FooterTemplate>
                                                            <asp:TextBox ID="txtTGVAddComments" runat="server"></asp:TextBox>                                                            
                                                        </FooterTemplate>
                                                    <ItemTemplate>
                                      ...
                                      <ContentTemplate>
                                        <asp:Panel ID="pnlWednessday" runat="server" ScrollBars="Horizontal">
                                         <h4><asp:Label ID="lblWed" runat="server" Text=""></asp:Label></h4>
                                           ...
                                           <br />
                                           <br />
                                         <asp:GridView ID="gvRecordsWed" runat="server" AutoGenerateColumns="False" AllowSorting="True" onsorting="gvRecordsWed_Sorting" HeaderStyle-ForeColor="#428bca" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Task" SortExpression="TL_Task">
                                                    <FooterTemplate>
                                                            <asp:DropDownList ID="ddlWAddTask" runat="server" onselectedindexchanged="ddlWAddTask_SelectedIndexChanged" AutoPostBack="True">
                                                            </asp:DropDownList>
                                                        </FooterTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Comments">
                                                    <FooterTemplate>
                                                            <asp:TextBox ID="txtWGVAddComments" runat="server"></asp:TextBox>                                                            
                                                        </FooterTemplate>
                                                    <ItemTemplate>
                                      ...
                                      <ContentTemplate>
                                       <asp:Panel ID="pnlThursday" runat="server" ScrollBars="Horizontal">
                                        <h4><asp:Label ID="lblThu" runat="server" Text=""></asp:Label></h4>
                                           ...
                                           <br />
                                           <br />
                                        <asp:GridView ID="gvRecordsThu" runat="server" AutoGenerateColumns="False" AllowSorting="True" onsorting="gvRecordsThu_Sorting" HeaderStyle-ForeColor="#428bca" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Task" SortExpression="TL_Task">
                                                    <FooterTemplate>
                                                            <asp:DropDownList ID="ddlTHAddTask" runat="server" onselectedindexchanged="ddlTHAddTask_SelectedIndexChanged" AutoPostBack="True">
                                                            </asp:DropDownList>
                                                        </FooterTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Comments">
                                                    <FooterTemplate>
                                                            <asp:TextBox ID="txtTHGVAddComments" runat="server"></asp:TextBox>                                                            
                                                        </FooterTemplate>
                                                    <ItemTemplate>
                                  ...
                                  <asp:UpdatePanel ID="upnlFri" runat="server" UpdateMode="Conditional">
                                      ...
                                      <asp:Panel ID="pnlFriday" runat="server" ScrollBars="Horizontal">
                                        <h4><asp:Label ID="lblFriday" runat="server" Text=""></asp:Label></h4>
                                           ...
                                           <br />
                                           <br />
                                        <asp:GridView ID="gvRecordsFri" runat="server" AutoGenerateColumns="False" AllowSorting="True" onsorting="gvRecordsFri_Sorting" HeaderStyle-ForeColor="#428bca" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Task" SortExpression="TL_Task">
                                                    <FooterTemplate>
                                                            <asp:DropDownList ID="ddlFAddTask" runat="server" onselectedindexchanged="ddlFAddTask_SelectedIndexChanged" AutoPostBack="True">
                                                            </asp:DropDownList>
                                                        </FooterTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Comments">
                                                    <FooterTemplate>
                                                            <asp:TextBox ID="txtFGVAddComments" runat="server"></asp:TextBox>                                                            
                                                        </FooterTemplate>
                                                    <ItemTemplate>
                                      ...
                                      <ContentTemplate>
                                       <asp:Panel ID="pnlSaturday" runat="server" ScrollBars="Horizontal">
                                        <h4><asp:Label ID="lblSat" runat="server" Text=""></asp:Label></h4>
                                           ...
                                           <br />
                                           <br />
                                        <asp:GridView ID="gvRecordsSat" runat="server" AutoGenerateColumns="False" AllowSorting="True" onsorting="gvRecordsSat_Sorting" HeaderStyle-ForeColor="#428bca" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Task" SortExpression="TL_Task">
                                                    <FooterTemplate>
                                                            <asp:DropDownList ID="ddlSAAddTask" runat="server" onselectedindexchanged="ddlSAAddTask_SelectedIndexChanged" AutoPostBack="True">
                                                            </asp:DropDownList>
                                                        </FooterTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Comments">
                                                    <FooterTemplate>
                                                            <asp:TextBox ID="txtSAGVAddComments" runat="server"></asp:TextBox>                                                            
                                                        </FooterTemplate>
                                                    <ItemTemplate>
