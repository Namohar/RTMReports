<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="EmployeeHoursByWeek, App_Web_diasz2zu" %>
                  ...
                  <table style="width: 100%;">
                      <tr>
                          <td style="text-align: right" width="40%">
                              <asp:Label ID="lblLoc" runat="server" Text="Select Locatioon:"></asp:Label>  </td>
                          <td>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:Button ID="btnExport" runat="server" onclick="btnExport_Click" 
                                  Text="Export to PDF" class="btn btn-primary"  />
                          </td>
                      </tr>
                      <tr>
                          <td style="text-align: right">
