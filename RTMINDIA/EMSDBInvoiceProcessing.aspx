<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EMSDBInvoiceProcessing.aspx.cs" Inherits="EMSDBInvoiceProcessing" %>
...
<div class="row">
	<div class="col-lg-12">
	 <h3 class="page-header"><i class="fa fa-file-o"></i>IP Invoices</h3>
	 <ol class="breadcrumb">
		<li><i class="fa fa-home"></i><a href="DashBoard.aspx">Home</a></li>
		<li><i class="fa fa-file-o"></i>IP Invoices</li>
	 </ol>
	</div>
  </div>
  <div class="row">
           ...
           <div class="panel-body">
             <div style="display:none"> 
              ...
              <div class="table-responsive">
                <asp:Panel ID="Panel2" runat="server" Width="100%" Height="400px" ScrollBars="Horizontal">
                      ...
                      <Columns>
                          ...
                          <asp:TemplateField HeaderText="File">
                             <HeaderTemplate>
                                    ...
                                    <asp:TextBox ID="txtSearch4" runat="server" placeholder="File" class="search_textbox" Width="100px"></asp:TextBox>
                                </HeaderTemplate>
                              <ItemTemplate>
                          ...
                          <asp:TemplateField HeaderText="Source">
                              <HeaderTemplate>
                                    ...
                                    <asp:TextBox ID="txtSearch5" runat="server" placeholder="Source" class="search_textbox" Width="100px"></asp:TextBox>
                                </HeaderTemplate>
                              <ItemTemplate>
                          ...
                          <asp:TemplateField HeaderText="Status">
                              <HeaderTemplate>
                                    ...
                                    <asp:TextBox ID="txtSearch6" runat="server" placeholder="Status" class="search_textbox" Width="100px"></asp:TextBox>
                                </HeaderTemplate>
                              <ItemTemplate>
                          ...
                          <asp:TemplateField HeaderText="Invoice#">
                             <HeaderTemplate>
                                    <asp:Label ID="Label8" runat="server" Text="Invoice#"></asp:Label><br />
                                    <asp:TextBox ID="txtSearch7" runat="server" placeholder="Invoice#" class="search_textbox" Width="100px"></asp:TextBox>
                                </HeaderTemplate>
                              <ItemTemplate>
                          ...
                          <asp:TemplateField HeaderText="IP Asg By">
                              <HeaderTemplate>
                                    ...
                                    <asp:TextBox ID="txtSearch18" runat="server" placeholder="IP Asg By" class="search_textbox" Width="100px"></asp:TextBox>
                                </HeaderTemplate>
                              <ItemTemplate>
                          ...
                          <asp:TemplateField HeaderText="IP Asg To">
                              <HeaderTemplate>
                                    ...
                                    <asp:TextBox ID="txtSearch8" runat="server" placeholder="IP Asg To" class="search_textbox" Width="100px"></asp:TextBox>
                                </HeaderTemplate>
                              <ItemTemplate>
                          ...
                          <asp:TemplateField HeaderText="Error#">
                              <HeaderTemplate>
                                    ...
                                    <asp:TextBox ID="txtSearch9" runat="server" placeholder="Error#" class="search_textbox" Width="100px"></asp:TextBox>
                                </HeaderTemplate>
                              <ItemTemplate>
                          ...
                          <asp:TemplateField HeaderText="QC Asg By">
                               <HeaderTemplate>
                                    <asp:Label ID="Label11" runat="server" Text="QC Asg By"></asp:Label><br />
                                    <asp:TextBox ID="txtSearch10" runat="server" placeholder="QC Asg By" class="search_textbox" Width="100px"></asp:TextBox>
                                </HeaderTemplate>
                              <ItemTemplate>
                          ...
                          <asp:TemplateField HeaderText="QC Asg To">
                              <HeaderTemplate>
                                    <asp:Label ID="Label12" runat="server" Text="QC Asg To"></asp:Label><br />
                                    <asp:TextBox ID="txtSearch11" runat="server" placeholder="QC Asg To" class="search_textbox" Width="100px"></asp:TextBox>
                                </HeaderTemplate>
                              <ItemTemplate>
