<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Payroll_Hours_Summary.aspx.cs" Inherits="Payroll_Hours_Summary" %>
...
<form id="Form1" runat="server">
    <div class="row">
	 <div class="col-lg-12">
		<h3 class="page-header"><i class="fa fa-table"></i>Payroll Hours Summary</h3>
	    	<ol class="breadcrumb">
				<li><i class="fa fa-home"></i><a href="DashBoard_Admin.aspx">Home</a></li>
				<li><i class="fa fa-table"></i>Payroll Hours Summary</li>
			</ol>
	 </div>
    </div>
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:Button ID="btnExport" runat="server" onclick="btnExport_Click" 
                                  Text="Export" class="btn btn-primary" OnClientClick="this.disabled = true; this.value = 'Please wait..';" UseSubmitBehavior="false" />
                          </td>
                      </tr>
                      <tr>
                          <td style="text-align: right">
