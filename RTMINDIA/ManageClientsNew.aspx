<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ManageClientsNew.aspx.cs" Inherits="ManageClientsNew" %>
          ...
          <div class="panel panel-default">
             ...
             <div class="panel-body">
                ...
                <asp:Button ID="btnUpload" runat="server" Text="Upload"
                         OnClick="btnUpload_Click" class="btn btn-primary" OnClientClick="this.disabled = true; this.value = 'Please wait...';" UseSubmitBehavior="false" ClientIDMode="Static" />
                     ...
                     <div class="panel-heading">
                      ...
                      <div class="panel-body">
                         <div class="col-md-6 col-sm-12 col-xs-12">                              
                            <asp:Label ID="lblClientSearch" runat="server" Text="Search Client:" Font-Bold="True"></asp:Label>
                            <asp:TextBox ID="txtClientSearch" runat="server" Width="200px" class="autosuggest tb10 ui-autocomplete" ClientIDMode="Static" ></asp:TextBox>                                   
                                     &nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnClientSearch" runat="server" Text="Search" onclick="btnClientSearch_Click" class="btn btn-primary" />
                         </div>
                         <div class="col-md-6 col-sm-12 col-xs-12" style="text-align:right">
                             <asp:Label ID="lblSelectTeam" runat="server" Text="Select Team:" Font-Bold="True"></asp:Label>
                             <asp:DropDownList ID="ddlTeam" runat="server" class="tb10" Width="170px">
                                    </asp:DropDownList>&nbsp;&nbsp;
                             <asp:Button ID="btnSaveClients" runat="server" Text="Save" 
                                 class="btn btn-primary" onclick="btnSaveClients_Click" OnClientClick="this.disabled = true; this.value = 'Please wait...';" UseSubmitBehavior="false" ClientIDMode="Static" />
                         </div>
                         <div class="col-md-12 col-sm-12 col-xs-12">
                         <asp:Panel ID="Panel2" runat="server" Height="350px" ScrollBars="Both">
                             <asp:GridView ID="grClients" runat="server" AutoGenerateColumns="False" 
                                     class="table table-striped table-bordered table-hover" 
                                 onrowdatabound="grClients_RowDataBound" onrowdeleting="grClients_RowDeleting">
                                 <Columns>
                                     <asp:TemplateField HeaderText="Job Code 0">
                                         <ItemTemplate>
                                            <asp:Label ID="lblJC0" runat="server" Text='<%# Eval("jobCode") %>'></asp:Label>
                                         </ItemTemplate>
                                     </asp:TemplateField>
                                    ...
                                    <%-- <asp:TemplateField HeaderText="Select Team" Visible="false">
                                        <ItemTemplate>
                                           <asp:DropDownList ID="ddlGVTeam" runat="server" Width="150px">
                                         </asp:DropDownList>
                                        </ItemTemplate>                                         
                                     </asp:TemplateField>--%>
                                     <asp:TemplateField HeaderText="Select Platform">
                                         <ItemTemplate>
                                            <asp:DropDownList ID="ddlGVPlatform" runat="server" Width="150px">
                                             </asp:DropDownList>
                                         </ItemTemplate>                                         
                                     </asp:TemplateField>
