...
public partial class HoursbyFullJobCode : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        dtResult = objclsTSheetReports.getResultClient( strQuery, txtFrom.Text, txtTo.Text);

        if (dtResult.Rows.Count > 0)
        {
            ExportToCSV(dtResult, "HoursbyFullJobCode");
        }
        else
        {
