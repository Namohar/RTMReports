...
public partial class HoursbyTeam : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        dtResult = objclsTSheetReports.getResultTeams(strQuery, txtFrom.Text, txtTo.Text);

    

        if (dtResult.Rows.Count > 0)
        {
            ExportToCSV(dtResult, "HoursbyGroup");
        }
        else
        {
