...
public partial class HoursByEmployee : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        dtResult = objclsTSheetReports.getResultEmployee(strQuery, txtFrom.Text, txtTo.Text);

        if (dtResult.Rows.Count > 0)
        {
            ExportToCSV(dtResult, "HoursbyEmployee");
        }
        else
        {
