<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EditLogs.aspx.cs" Inherits="EditLogs" %>
                  ...
                  <ContentTemplate>                
                         ...
                         <tr>
                             ...
                             <td>
                                 <asp:Button ID="btnDisplay" runat="server" onclick="btnDisplay_Click" 
                                   OnClientClick="this.disabled = true; this.value = 'Please wait...';" UseSubmitBehavior="false"  Text="Display" class="btn btn-primary" />
                             </td>
                         </tr>
                         <tr>
                             <td style="text-align: right">
                         ...
                         <tr>
                             <td style="text-align: right" class="style1" colspan="2">
                                ...
                                <asp:Panel ID="pnlAdd" runat="server" ScrollBars="None">
                                 <asp:GridView ID="gvLogs" runat="server" AutoGenerateColumns="False" DataKeyNames="LA_ID" EmptyDataText="No data found" 
                                ...
                                <td style="text-align: left" colspan="2">
                                    <asp:DropDownList ID="ddlReason" runat="server" Width="200px" 
                                       ...
                                       <asp:ListItem>--Select Reason--</asp:ListItem>
                                        ...
                                        <asp:ListItem>Peer Support</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left" colspan="2">
                                    <asp:DropDownList ID="ddlCategory" runat="server" AutoPostBack="True" 
                                        ...
                                        <asp:ListItem>Client Specific</asp:ListItem>
                                        <asp:ListItem>Employee Engagement Activity</asp:ListItem>
                    ...
                    <div class="footer" align="right">
                        ...
                        <asp:Button ID="btnNo" runat="server" Text="Cancel" CssClass="no" 
                            onclick="btnNo_Click" OnClientClick="this.disabled = true; this.value = 'Please wait...';" UseSubmitBehavior="false" />
                    </div>
                </div>
                </ContentTemplate>
                  </asp:UpdatePanel>
