<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DashBoard_Admin.aspx.cs" Inherits="DashBoard_Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   <form runat="server">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div style="text-align: center">
                                    ...
                                    <asp:Label ID="lblTeam" runat="server" Text="Select Team" Font-Bold="True" 
            ...
            <div id="dvCharts" runat="server" visible="false">
            <div  class="row" >
        ...
        <div class="row">
           <div class="col-md-12 col-sm-12 col-xs-12">
                 <div class="panel panel-default">
                 <div class="panel-heading">
                    <asp:Label ID="lblSummaryHeading" runat="server" Text="" Visible="false"></asp:Label>
                 </div>
                 <div class="panel-body">
        ...
        <div class="row">
           <div class="col-md-12 col-sm-12 col-xs-12">
                 <div class="panel panel-default">
                 <div class="panel-heading">
                    <asp:Label ID="lblWeekHeading" runat="server" Text="" Visible="false"></asp:Label>
                 </div>
                 <div class="panel-body">
                      <asp:Chart ID="Chart5" runat="server" Width="900px" Height="350px" Palette="Bright" >
                        <Series>
        ...
        <%--<div>
             <asp:LinkButton ID="btnExport" runat="server" onclick="btnExport_Click">Export to Excell</asp:LinkButton>
         </div>--%>
   </form>
</asp:Content>
