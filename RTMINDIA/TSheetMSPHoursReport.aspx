<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TSheetMSPHoursReport.aspx.cs" Inherits="TSheetMSPHoursReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="row">
	 <div class="col-lg-12">
		<h3 class="page-header"><i class="fa fa-table"></i>MSP Hours Report (Before 04/01/2017)</h3>
	    	<ol class="breadcrumb">
				<li><i class="fa fa-home"></i><a href="DashBoard_Admin.aspx">Home</a></li>
				<li><i class="fa fa-table"></i>MSP Hours Report (Before 04/01/2017)</li>
			</ol>
	 </div>
    </div>
                      ...
                      <tr>
                       ...
                       <tr>
                          <td style="text-align: right">
                              <asp:Label ID="Label1" runat="server" Text="Select Team :"></asp:Label> </td>
                          <td>
                              <asp:DropDownList ID="ddlTeams" runat="server" Width="294px" Height="34px">
                              </asp:DropDownList>
                          </td>
                      </tr>
                       <tr>
...
//                });
                ...
                $(function () {
                    $(".txtSunDate").datepicker({ dateFormat: 'mm/dd/yy', maxDate: new Date(2017, 02, 26), beforeShowDay:
             function (dt) {
                 return [dt.getDay() == 0, ""];
             }
                    });
     ...
     $(function () {
//        '' $("#txtTo").datepicker({ maxDate: 03 / 13 / 2017 });
         $(".txtSatDate").datepicker({ dateFormat: 'mm/dd/yy', maxDate: new Date(2017, 03, 01), beforeShowDay:
             function (dt) {
                 return [dt.getDay() == 6, ""];
