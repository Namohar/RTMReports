<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="RUChart.aspx.cs" Inherits="RUChart" ValidateRequest="false" %>
     ...
     <div class="col-md-12 col-sm-12 col-xs-12">
         <div class="panel panel-default">
             <div class="panel-body">
                 <asp:Chart ID="Chart1" runat="server" Width="900px" Height="550px" 
                        oncustomize="Chart1_Customize" AntiAliasing="All">
                    <Series>
