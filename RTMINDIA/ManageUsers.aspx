...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <%--                  <asp:DropDownList ID="ddlTeam" runat="server" class="form-control" 
                    ...
                    <asp:TextBox ID="txtEmpId" runat="server" class="form-control" MaxLength="15"></asp:TextBox>
                    <br />
               ...
               <div class="col-lg-6">
                <div class="form-group">
                   <br />
                    ...
                    <asp:TextBox ID="txtMgrId" runat="server" class="form-control" MaxLength="15"></asp:TextBox>
                    <br />
