<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="IPV_ScoreCard.aspx.cs" Inherits="IPV_ScoreCard" %>
...
<form id="Form1" runat="server">
  ...
  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-bar-chart-o"></i> IPV Score Card</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="DashBoard_Admin.aspx">Home</a></li>
						<li><i class="fa fa-bar-chart-o"></i>IPV</li>
					</ol>
				</div>
			</div>
    <div class="row" >
       ...
       <ContentTemplate>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
           <div class="panel panel-default">
              <div class="panel-heading">
                 <asp:Label ID="lblLine1Header" runat="server" Text="IPV Strike Rate (Invoices/Hour)"></asp:Label>
              </div>
           ...
           <div class="panel panel-default">
              <div class="panel-heading">
                 <asp:Label ID="lblLine2Header" runat="server" Text="IPV Strike Rate (Cumulative)"></asp:Label>
              </div>
              <div class="panel-body">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
           <div class="panel panel-default">
              ...
              Text="IPV Invoice Processing (Client and Analyst Details)" Font-Bold="True" 
              Font-Size="Medium" ForeColor="#003399" ClientIDMode="Static"></asp:Label>
              </div>
              <div class="panel-body">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
           <div class="panel panel-default">
              <div class="panel-heading">
                  <asp:Label ID="lblHeading2" runat="server" 
              Text="IPV Invoice Processing (Client and Analyst Details)" Font-Bold="True" 
              Font-Size="Medium" ForeColor="#003399" ClientIDMode="Static"></asp:Label>
              </div>
              <div class="panel-body">
