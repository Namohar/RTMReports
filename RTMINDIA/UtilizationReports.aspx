<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="UtilizationReports.aspx.cs" Inherits="UtilizationReports" ValidateRequest="false" %>
              ...
              <div class="panel-body">
                 <div style="text-align:center; width: 100%;"> 
                  ...
                  <div style="text-align: center; overflow:auto; width:100%">
                    ...
                    <br />
                    <asp:Chart ID="Chart2" runat="server" Height="600px" Width="1200px"
                        BackSecondaryColor="White" Visible="False" BorderlineColor="DarkBlue" 
                        BorderlineDashStyle="Dash">
                        <Series>
                            <asp:Series Name="Series1" CustomProperties="PointWidth=0.8">
