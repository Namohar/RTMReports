<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="HoursbyFullJobCode.aspx.cs" Inherits="HoursbyFullJobCode" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="row">
	 <div class="col-lg-12">
		<h3 class="page-header"><i class="fa fa-table"></i>Hours by Full Job Code</h3>
	    	<ol class="breadcrumb">
				<li><i class="fa fa-home"></i><a href="DashBoard_Admin.aspx">Home</a></li>
				<li><i class="fa fa-table"></i>Hours by Full Job Code</li>
			</ol>
	 </div>
    </div>
...
<%--    <div class="loading" align="center"> 
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $(".txtSatDate").datepicker({ beforeShowDay:
             function (dt) {
                 return [dt.getDay() == 6, ""];
             }
            });
